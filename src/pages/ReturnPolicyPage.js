    ...
    <>
      ...
      <div data-aos="fade-up" className="max-w-5xl mx-auto mt-6 p-6">
        ...
        <div className="text-sm md:text-base my-5 text-left space-y-5">
          ...
          <p>
            At {toProperCase(COMPANY_INFO.COMPANY_NAME)}, your satisfaction is
            our top priority. If you find that your purchase does not meet your
            expectations or is not in the condition you anticipated, you have
            the option to return it within 7 days of receipt. We will cover the
            shipping costs for the return, ensuring a hassle-free process for
            you. Simply reach out to us via WhatsApp at{" "}
            {COMPANY_INFO.COMPANY_WHATSAPP_NUMBER}, and we will assist you
            through every step of the return procedure.
          </p>
          <p>
          ...
          <p>
            ...
            are committed to providing you with exceptional products and
            excellent service.
          </p>
        </div>
      </div>
